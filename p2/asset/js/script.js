...
buttonWhite.addEventListener('click', function() {
    ...
    var src = "../p2/asset/php/updateWhite.php";
...
buttonBlack.addEventListener('click', function() {
    ...
    var src = "../p2/asset/php/updateBlack.php";
...
var checkPlayerWhite = setInterval(() => {
    ...
    var src = "../p2/asset/php/checkPlayerWhite.php";
...
var checkPlayerBlack = setInterval(() => {
    ...
    var src = "../p2/asset/php/checkPlayerBlack.php";
